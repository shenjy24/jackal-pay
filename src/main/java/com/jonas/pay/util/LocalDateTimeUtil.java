...
public class LocalDateTimeUtil {
    ...
    public static boolean isBetween(LocalDateTime startTime, LocalDateTime endTime) {
        ...
        return cn.hutool.core.date.LocalDateTimeUtil.isIn(LocalDateTime.now(), startTime, endTime);
    }
    ...
    public static boolean isBetween(String startTime, String endTime) {
        ...
        return cn.hutool.core.date.LocalDateTimeUtil.isIn(LocalDateTime.now(),
    ...
    public static boolean isOverlap(LocalTime startTime1, LocalTime endTime1, LocalTime startTime2, LocalTime endTime2) {
        LocalDate nowDate = LocalDate.now();
        return cn.hutool.core.date.LocalDateTimeUtil.isOverlap(LocalDateTime.of(nowDate, startTime1), LocalDateTime.of(nowDate, endTime1),
